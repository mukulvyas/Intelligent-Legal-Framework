...
!huggingface-cli login --token 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

model.push_to_hub("mukulvyas99/LawChatTinyLlama2", check_pr=True)

tokenizer.push_to_hub("mukulvyas99/LawChatTinyLlama2",check_pr=True)
